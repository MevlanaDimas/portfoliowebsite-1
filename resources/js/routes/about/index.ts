...
/**
* @see \App\Http\Controllers\AboutController::activating
 * @see app/Http/Controllers/AboutController.php:30
 * @route '/about/{id}/activating'
 */
export const activating = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: activating.url(args, options),
    method: 'patch',
})

activating.definition = {
    methods: ["patch"],
 ...
 * @route '/about/{id}/activating'
 */
activating.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
    ...
    return activating.definition.url
 ...
 * @route '/about/{id}/activating'
 */
activating.patch = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: activating.url(args, options),
    method: 'patch',
})
 ...
 * @route '/about/{id}/activating'
 */
    const activatingForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: activating.url(args, {
                    [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                        _method: 'PATCH',
                        ...(options?.query ?? options?.mergeQuery ?? {}),
                    }
 ...
 * @route '/about/{id}/activating'
 */
        activatingForm.patch = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: activating.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
    ...
    activating.form = activatingForm
const about = {
...
activating: Object.assign(activating, activating),
}
